...
topdir = .
BUILD_DIR = /B/Prog/bash
top_builddir = /B/Prog/bash
srcdir = .
VPATH = .
...
OS = linux-gnueabi
VENDOR = unknown
MACHTYPE = armv7l-unknown-linux-gnueabi
...
# tests
LIBINTL = lib/intl/libintl.a 
LTLIBINTL = lib/intl/libintl.a 
INTLLIBS = lib/intl/libintl.a 
INTLOBJS = $(GETTOBJS)
